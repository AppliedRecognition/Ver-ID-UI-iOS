...
/// note:
/// Removed, use session delegate instead
...
/// Renamed <code>faceCaptureCount</code>
...
/// Renamed <code>maxDuration</code>
@property (nonatomic) NSTimeInterval expiryTime;
/// Set this to record a video of the session
/// note:
/// This property is ignored. Please use session delegate.
@property (nonatomic, copy) NSURL * _Nullable videoURL;
/// This property is ignored. All faces in the session result now include the face template by default.
@property (nonatomic) BOOL includeFaceTemplatesInResult;
/// Set to <code>true</code> to enable spoken prompts
/// note:
/// Removed, use session delegate
...
/// note:
/// Unavailable: Please use session delegate
@property (nonatomic) BOOL useFrontCamera;
/// Renamed to <code>faceCaptureFaceCount</code>
...
/// since:
/// 2.14.0
@property (nonatomic) BOOL isSunglassesDetectionEnabled;
/// Set to <code>false</code> to disable spoof detection (instant liveness)
/// since:
/// 2.7.0
@property (nonatomic) BOOL isSpoofDeviceDetectionEnabled;
@property (nonatomic) BOOL isSpoofDetectionEnabled SWIFT_DEPRECATED_MSG("", "isSpoofDeviceDetectionEnabled");
/// Set to <code>false</code> to disable screen artifact detection (instant liveness)
/// since:
/// 2.7.0
@property (nonatomic) BOOL isMoireDetectionEnabled;
@property (nonatomic) BOOL isScreenArtifactDetectionEnabled SWIFT_DEPRECATED_MSG("", "isMoireDetectionEnabled");
/// Mask detection confidence threshold (0.0–1.0)
/// since:
/// 2.7.0
@property (nonatomic) float faceCoveringConfidenceThreshold;
/// Sunglasses detection confidence threshold (0.0–1.0)
/// since:
/// 2.14.0
@property (nonatomic) float sunglassesConfidenceThreshold;
...
/// since:
/// 2.7.0
@property (nonatomic) NSInteger minSpoofCaptureCount SWIFT_DEPRECATED;
/// URL of the model file used for spoof device detection (instant liveness)
/// note:
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) VerIDClassifier * _Nonnull glasses;)
+ (VerIDClassifier * _Nonnull)glasses SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) VerIDClassifier * _Nonnull faceQuality;)
+ (VerIDClassifier * _Nonnull)faceQuality SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9VerIDCore11CoreSession")
@interface CoreSession : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface VerIDDeviceInfo : NSObject
/// Device model
...
/// Face
@property (nonatomic, readonly, strong) VerIDRecognizableFace * _Nonnull face;
/// Bearing of the face
@property (nonatomic) enum VerIDBearing bearing;
/// URL of the image in which the face was detected
/// note:
/// Removed, use <code>image</code> property instead
...
///
- (nonnull instancetype)initWithFace:(VerIDRecognizableFace * _Nonnull)face bearing:(enum VerIDBearing)bearing imageURL:(NSURL * _Nullable)imageURL OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("'init' has been renamed to 'initWithFace:bearing:image:error:'");
- (nullable instancetype)initWithFace:(VerIDRecognizableFace * _Nonnull)face bearing:(enum VerIDBearing)bearing image:(UIImage * _Nonnull)image error:(NSError * _Nullable * _Nullable)error;
- (nullable instancetype)initWithFaces:(NSArray<VerIDRecognizableFace *> * _Nonnull)faces bearing:(enum VerIDBearing)bearing image:(UIImage * _Nonnull)image error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// returns:
/// Array of faces
- (NSArray<VerIDFace *> * _Nullable)detectFacesInImage:(id <VerIDImageProvider> _Nonnull)image limit:(int32_t)limit options:(NSUInteger)options error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, readonly, strong) Image * _Nonnull image;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (NSArray<id <VerIDRecognizable>> * _Nullable)createRecognizableFacesFromFaces:(NSArray<VerIDFace *> * _Nonnull)faces inImage:(id <VerIDImageProvider> _Nonnull)image error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
- (VerIDFace * _Nullable)trackFaceInImage:(id <VerIDImageProvider> _Nonnull)image error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_PROTOCOL_NAMED("ImageProvider")
@protocol VerIDImageProvider
- (Image * _Nullable)provideVerIDImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)provideUIImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isImageMirrored SWIFT_WARN_UNUSED_RESULT;
@end

@class NSData;

SWIFT_CLASS("_TtC9VerIDCore5Image")
@interface Image : NSObject <VerIDImageProvider>
- (Image * _Nullable)provideVerIDImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)provideUIImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isImageMirrored SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic) CGSize uprightSize;
- (nonnull instancetype)initWithData:(NSData * _Nonnull)data width:(NSInteger)width height:(NSInteger)height orientation:(CGImagePropertyOrientation)orientation bytesPerRow:(NSInteger)bytesPerRow format:(VerIDImageFormat)format OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithRecognitionData:(NSData * _Nonnull)recognitionData OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED;
- (nullable instancetype)initWithRecognitionData:(NSData * _Nonnull)recognitionData version:(int32_t)version error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
...
/// since:
/// 2.6.0
SWIFT_CLASS_NAMED("SystemInfo")
@interface VerIDSystemInfo : NSObject
/// Device information
@property (nonatomic, readonly, strong) VerIDDeviceInfo * _Nonnull deviceInfo;
/// Ver-ID version
@property (nonatomic, readonly, copy) NSString * _Nonnull veridVersion;
/// Class used for face detection
@property (nonatomic, readonly, copy) NSString * _Nonnull faceDetectionClassName;
/// Class used for face recognition
@property (nonatomic, readonly, copy) NSString * _Nonnull faceRecognitionClassName;
/// Class used for user management
@property (nonatomic, readonly, copy) NSString * _Nonnull userManagementClassName;
/// Ver-ID settings
@property (nonatomic, readonly, strong) DetRecLibSettings * _Nonnull veridSettings;
/// Default face template version
@property (nonatomic, readonly, copy) NSString * _Nonnull defaultFaceTemplateVersion;
/// Markdown representation of system information
@property (nonatomic, copy) NSString * _Nonnull markdown;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface UIImage (SWIFT_EXTENSION(VerIDCore)) <VerIDImageProvider>
- (Image * _Nullable)provideVerIDImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)provideUIImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isImageMirrored SWIFT_WARN_UNUSED_RESULT;
@end
...
@required
- (void)deleteAllWithCompletion:(void (^ _Nullable)(NSError * _Nullable))completion;
@end
...
/// since:
/// 2.6.0
@property (nonatomic, strong) VerIDSystemInfo * _Nonnull systemInfo;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (NSNumber * _Nullable)extractAttributeFromFace:(VerIDFace * _Nonnull)face image:(id <VerIDImageProvider> _Nonnull)image using:(NSString * _Nonnull)classifier error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<id <VerIDRecognizable>> * _Nullable)createRecognizableFacesFromFaces:(NSArray<VerIDFace *> * _Nonnull)faces inImage:(id <VerIDImageProvider> _Nonnull)image faceTemplateVersion:(VerIDFaceTemplateVersion)faceTemplateVersion error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// Whether to check for incompatible face templates
/// since:
/// 2.12.0
/// \param factory Factory that’s creating the Ver-ID instance
///
///
/// returns:
/// <code>false</code> to skip incompatible face template check
- (BOOL)shouldCheckForIncompatibleFaceTemplatesIn:(VerIDFactory * _Nonnull)factory SWIFT_WARN_UNUSED_RESULT;
/// Whether to check for corrupt face templates
/// since:
/// 2.12.0
/// \param factory Factory that’s creating the Ver-ID instance
///
///
/// returns:
/// <code>false</code> to skip corrupt face template check
- (BOOL)shouldCheckForCorruptFaceTemplatesIn:(VerIDFactory * _Nonnull)factory SWIFT_WARN_UNUSED_RESULT;
@end


///
SWIFT_CLASS("_TtC9VerIDCore10VerIDImage")
@interface VerIDImage : NSObject <VerIDImageProvider>
- (Image * _Nullable)provideVerIDImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)provideUIImageAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isImageMirrored SWIFT_WARN_UNUSED_RESULT;
/// Sample buffer
