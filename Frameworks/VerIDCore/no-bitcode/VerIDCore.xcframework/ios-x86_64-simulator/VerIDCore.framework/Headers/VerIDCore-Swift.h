...
/// since:
/// 2.7.0
@property (nonatomic) BOOL isSpoofDetectionEnabled;
/// Set to <code>false</code> to disable screen artifact detection (instant liveness)
/// since:
/// 2.7.0
@property (nonatomic) BOOL isScreenArtifactDetectionEnabled;
...
/// since:
/// 2.7.0
@property (nonatomic) float spoofConfidenceThreshold;
/// Number of spoof captures before the session fails with spoof error
/// since:
/// 2.7.0
@property (nonatomic) NSInteger minSpoofCaptureCount;
/// URL of the model file used for spoof detection (instant liveness)
/// note:
/// Default model shipped with the SDK will be used if the URL is set to <code>nil</code>
/// since:
/// 2.7.0
@property (nonatomic, copy) NSURL * _Nullable spoofDetectionModelFileURL;
/// Moire spoof confidence threshold (0.0–1.0)
/// since:
/// 2.7.0
@property (nonatomic) float screenArtifactConfidenceThreshold;
/// URL of the model file used for moire spoof detection
/// note:
/// Default model shipped with the SDK will be used if the URL is set to <code>nil</code>
/// since:
/// 2.7.0
@property (nonatomic, copy) NSURL * _Nullable screenArtifactDetectionModelFileURL;
...
@property (nonatomic) BOOL shouldDeleteIncompatibleFaces;
/// Constructor
