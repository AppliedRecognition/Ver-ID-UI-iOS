...
@objc open class VerIDSessionViewControllersFactory: NSObject, SessionViewControllersFactory {
    ...
    /// - Since: 2.12.0
    @objc public var shouldShowCancelButtonInVerIDViewController: Bool = true
    ...
    open func makeVerIDViewController() throws -> UIViewController & VerIDViewControllerProtocol {
        ...
        viewController.shouldShowCancelButton = self.shouldShowCancelButtonInVerIDViewController
        viewController.sessionTheme = self.sessionTheme
