...
public class FaceOvalView: UIView {
    ...
    public var strokeColour: UIColor = {
        if #available(iOS 13, *) {
            ...
            return UIColor(named: "systemLabel", in: ResourceHelper.bundle, compatibleWith: nil) ?? UIColor.black
        }
    }() {
        didSet {
            self.ovalLayer.strokeColor = self.strokeColour.cgColor
        }
    }
    ...
    public func drawArrow(angle: CGFloat, distance: CGFloat) {
        ...
        self.arrowLayer?.strokeColor = UIColor.white.cgColor
    ...
    public func drawImage(_ image: UIImage, ofFace face: Face, mirrored: Bool) {
        ...
        faceLayer.strokeColor = self.strokeColour.cgColor
