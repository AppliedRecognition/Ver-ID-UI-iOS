Pod::Spec.new do |s|
    ...
    s.subspec 'Core' do |ss|
        ...
        ss.vendored_framework = "Frameworks/iSpiralCore/bitcode/iSpiral.xcframework"
    end
    ...
    s.subspec 'Core-no-bitcode' do |ss|
        ...
        ss.dependency 'RxSwift', '~> 5'
        ss.dependency 'RxCocoa', '~> 5'
        ss.vendored_framework = "Frameworks/iSpiralCore/no-bitcode/iSpiral.xcframework"
    end
end